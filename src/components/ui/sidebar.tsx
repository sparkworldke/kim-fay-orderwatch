...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-6 shrink-0 items-center rounded-md px-2 text-[10px] font-medium uppercase tracking-wide text-sidebar-foreground/60 outline-none ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-3 [&>svg]:shrink-0",
